...
public class GenreController : ControllerBase
{
    ...
    {
        GenreRelationship[] genreRelationshipArray = (await m_catalogServiceClient.GetGenreRelationshipsAsync(genreId, includeReverseRelationships)).ToArray();
        return Ok(genreRelationshipArray);
    }
